...
def main():
  ...
  Add regularization to forward pass.
  
  Checks:
  - gradient correct with and without batch norm and with and without regularization
  - test acc results from ass2 cannot be reproduced (0.12 after 32 epochs)
      Possible reasons:
           - not all data is used (only data batch 1 and maybe 4 more needed)
           - forgot regularization in forward pass
  """
  num_classes=10
  np.random.seed(12)
